...
#Generic endpoint for all github calls which sets up the headers
...
#This prints a report to the screen to show activity in the last week.
def make_report(owner, repo, token):
